...
const pages: Record<string, LegalPage> = {
  ...
  devoluciones: {
    ...
    sections: [
      ...
      { title: 'Cómo comunicar el desistimiento', paragraphs: ['El consumidor puede utilizar el modelo incluido en esta página o cualquier declaración inequívoca que identifique el pedido y exprese su decisión de desistir. La comunicación debe enviarse dentro del plazo legal al canal de atención publicado por el titular de la tienda. La carga de probar que la comunicación se realizó dentro de plazo corresponde al consumidor.'] },
      ...
      { title: 'Modelo de desistimiento', paragraphs: ['A la atención de GHC Nutrition / titular legal: Por la presente comunico que desisto de mi contrato de venta del siguiente bien o bienes: [producto]. Pedido: [número]. Recibido el: [fecha]. Nombre del consumidor: [nombre]. Dirección: [dirección]. Fecha: [fecha]. Firma: únicamente si se presenta en papel.'] },
    ],
  },
  terminos: {
    ...
    notice: 'Antes de activar cobros reales falta incorporar un dato legal obligatorio: la identificación completa del titular de la tienda (nombre o razón social, NIF/CIF, domicilio profesional, correo electrónico de contacto y, en su caso, datos registrales). Hasta completar ese bloque, la tienda no debe considerarse jurídicamente lista para aceptar pedidos reales.',
    sections: [
      { title: '1. Titular y prestador del servicio', paragraphs: ['GHC Nutrition es la marca comercial utilizada en este sitio. La identificación fiscal y mercantil completa del prestador debe figurar de forma permanente, fácil, directa y gratuita antes de la apertura comercial, de acuerdo con el artículo 10 de la Ley 34/2002 de servicios de la sociedad de la información y de comercio electrónico.'] },
  ...
  privacidad: {
    ...
    notice: 'Falta incorporar la identidad y los datos de contacto completos del responsable del tratamiento. Son datos obligatorios conforme al RGPD y la LOPDGDD y deben publicarse antes de activar ventas reales.',
    sections: [
      { title: '1. Responsable del tratamiento', paragraphs: ['El responsable será el titular legal que opere GHC Nutrition. Antes de la apertura comercial deberán constar aquí su nombre o razón social, NIF/CIF, domicilio profesional y correo electrónico específico o válido para privacidad.'] },
      ...
      { title: '7. Derechos de las personas', paragraphs: ['El interesado puede ejercer, cuando proceda, los derechos de acceso, rectificación, supresión, oposición, limitación del tratamiento y portabilidad, así como retirar el consentimiento sin afectar a la licitud del tratamiento previo.', 'La solicitud debe permitir verificar razonablemente la identidad del solicitante y concretar el derecho que desea ejercer. Cuando el canal de privacidad esté publicado, podrá utilizarse para estas solicitudes. También puede presentar una reclamación ante la Agencia Española de Protección de Datos (AEPD), www.aepd.es.'] },
  ...
  contacto: {
    ...
    notice: 'Antes de activar pedidos reales debe publicarse aquí el correo electrónico de contacto directo del titular y, cuando corresponda, otros datos exigidos por la normativa de comercio electrónico.',
    sections: [
      { title: 'Atención al cliente', paragraphs: ['Las consultas sobre pedidos deben incluir, cuando sea posible, la referencia de pedido, nombre del comprador y una descripción concreta de la incidencia. Nunca envíes por correo datos completos de tarjeta, claves o contraseñas.'] },
      { title: 'Devoluciones y desistimiento', paragraphs: ['Las comunicaciones de desistimiento pueden realizarse mediante una declaración inequívoca dentro del plazo legal. Consulta la Política de devoluciones para conocer plazos, costes y excepciones aplicables a productos desprecintados.'] },
      { title: 'Protección de datos', paragraphs: ['Las solicitudes de acceso, rectificación, supresión, oposición, limitación o portabilidad se atenderán por el canal de privacidad que se publique con la identificación legal del responsable.'] },
  ...
  desistimiento: {
    ...
    sections: [
      { title: 'Formulario', paragraphs: ['A la atención de GHC Nutrition / titular legal:', 'Por la presente le comunico que desisto de mi contrato de venta del siguiente bien o bienes: [indicar producto/s].', 'Número o referencia del pedido: [indicar].', 'Fecha de pedido: [indicar]. Fecha de recepción: [indicar].', 'Nombre y apellidos del consumidor: [indicar].', 'Dirección del consumidor: [indicar].', 'Fecha de la comunicación: [indicar].', 'Firma del consumidor: únicamente si este formulario se presenta en papel.'] },
    ...
    <main className="min-h-screen bg-[#F2F4F1] text-[#050706]">
      ...
      <footer className="bg-[#050706] text-white">
        <div className="mx-auto flex max-w-5xl flex-col gap-4 px-5 py-8 text-xs text-white/45 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p>RGPD · LOPDGDD · LSSI-CE · TRLGDCU · normativa española y de la UE aplicable</p>
        </div>
      </footer>
    </main>
  )
