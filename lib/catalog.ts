...
export const products: Product[] = [
  ...
  },
  {
    ...
    use: 'Mezclar una toma con agua o bebida vegetal. La etiqueta oficial debe prevalecer si el dosificador del envase indica una cantidad distinta.',
  ...
  },
  {
    ...
    serving: '3 g',
    use: 'Mezclar 3 g en aproximadamente 200 ml de agua. Prioriza la constancia diaria y sigue las indicaciones del etiquetado o del profesional que lleve tu pauta.',
  ...
  },
  {
    ...
    serving: '10 g',
    use: 'Mezclar 10 g (2 cazos según ficha de producto) en unos 200 ml de agua y tomar según la pauta deportiva elegida.',
    ...
    note: 'Composición contrastada con catálogo Beverly; comprobar siempre el envase ante cambios de formulación.',
  },
  {
    id: 'map-300g',
